<div class="px-5 mt-4 container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-end">
        <a href="{{ route('admin.especialidades.nuevo') }}" class="btn btn-secondary">Agregar Nueva Especialidad</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-2 d-flex justify-content-center">
                                    <a href="{{ route('admin.especialidades.edit', $especialidad->ID_especialidad) }}"
                                        class="btn btn-sm btn-secondary">
                                        Editar
                                    </a>
                                    <form
                                        action="{{ route('admin.especialidades.destroy', $especialidad->ID_especialidad) }}"
                                        method="POST"
