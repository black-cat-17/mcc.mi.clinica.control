<div class="px-5 mt-4 container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-end">
        <a href="{{ route('admin.facultativos.nuevo') }}" class="btn btn-secondary">Agregar Nuevo Facultativo</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-2 d-flex justify-content-center">
                                    <a href="{{ route('admin.facultativos.edit', $facultativo->ID_facultativo) }}"
                                        class="btn btn-sm btn-secondary">
                                        Editar
                                    </a>
                                    <form
                                        action="{{ route('admin.facultativos.destroy', $facultativo->ID_facultativo) }}"
                                        method="POST"
