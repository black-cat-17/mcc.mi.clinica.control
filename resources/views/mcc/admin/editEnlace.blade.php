        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.enlaces.update', $enlace->ID_enlace) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="ID_user" class="form-control">
                                    @foreach ($usuarios as $usuario)
                                        <option value="{{ $usuario->ID_user }}"
                                            {{ old('ID_user') == $usuario->ID_user ? 'selected' : '' }}>
                            ...
                            <div class="mb-3 d-flex justify-content-between">
                                ...
                                <a href="{{ route('admin.enlaces') }}" class="btn btn-danger">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
