<div class="px-5 mt-4 container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-end">
        <a href="{{ route('facultativo.enlaces.nuevo') }}" class="btn btn-secondary">Agregar Nuevo Enlace</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-2 d-flex justify-content-center">
                                    <a href="{{ route('facultativo.enlaces.edit', $enlace->ID_enlace) }}"
                                        class="btn btn-sm btn-secondary">
                                        Editar
                                    </a>
                                    <form action="{{ route('facultativo.enlaces.destroy', $enlace->ID_enlace) }}"
                                        method="POST"
    ...
    <div class="mt-3 d-flex justify-content-center">
        {{ $todosEnlaces->links('pagination::bootstrap-5') }}
    </div>
