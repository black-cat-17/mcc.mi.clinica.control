        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('facultativo.especialidades.update', $especialidad->ID_especialidad) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3 d-flex justify-content-between">
                                ...
                                <a href="{{ route('facultativo.especialidades') }}" class="btn btn-danger">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
