<div class="px-5 mt-4 container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-end">
        <a href="{{ route('paciente.documentos.nuevo') }}" class="btn btn-secondary">Agregar Nuevo Documento</a>
    </div>
    ...
    <div class="table-responsive">
        ...
        <table class="table align-middle table-bordered table-hover">
            ...
            <tbody>
                ...
                @if ($Usuariosdocumentos->isEmpty())
                    <tr>
                        <td colspan="6" class="text-center">No hay documentos que mostrar</td>
                    </tr>
                @else
                    @forelse ($Usuariosdocumentos as $documento)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-2 d-flex justify-content-center">
                                    <a href="{{ route('paciente.documentos.edit', $documento->ID_documento) }}"
                                        class="btn btn-sm btn-secondary">
                                        Editar
                                    </a>
                                    <form action="{{ route('paciente.documentos.destroy', $documento->ID_documento) }}"
                                        method="POST"
    ...
    <div class="mt-3 d-flex justify-content-center">
        {{ $Usuariosdocumentos->links('pagination::bootstrap-5') }}
    </div>
