<div class="px-5 mt-4 container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-end">
        <a href="{{ route('paciente.enlaces.nuevo') }}" class="btn btn-secondary">Agregar Nuevo Enlace</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-2 d-flex justify-content-center">
                                    <a href="{{ route('paciente.enlaces.edit', $enlace->ID_enlace) }}"
                                        class="btn btn-sm btn-secondary">
                                        Editar
                                    </a>
                                    <form action="{{ route('paciente.enlaces.destroy', $enlace->ID_enlace) }}"
                                        method="POST"
    ...
    <div class="mt-3 d-flex justify-content-center">
        {{ $UsuariosEnlaces->links('pagination::bootstrap-5') }}
    </div>
