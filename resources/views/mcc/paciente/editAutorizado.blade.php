        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="mb-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('paciente.autorizados.update', $autorizado->ID_autorizado) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="ID_facultativo" id="ID_facultativo" class="form-control" disabled>
                                        @foreach ($facultativos as $facultativo)
                                            <option value="{{ $facultativo->id }}"
                                                @if ($autorizado->ID_facultativo == $facultativo->id) selected @endif>
                                ...
                                <div class="mb-3 d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('paciente.autorizados') }}" class="btn btn-danger">Cancelar</a>
                                </div>
                        </form>
                    </div>
                </div>
